...
numbers = [
    1, 2, 3, 4, 8, 9, 11, 12, 13, 14, 15, 16, 17, 22, 23, 28, 29, 33, 34, 38,
...
class SpecialCheckboxes:
    ...
    def click_only_special_checkboxes(self):
        checkboxes = self.driver.find_elements(By.CSS_SELECTOR, 'input.check')
